...
class LinksyncApiController {
    ...
    public static function get_key_info($laid_key = null){
         ...
         */
        $apiConfig = self::get_config();
        $api = new LinksyncApi( $apiConfig, $laid_key );
    ...
    public static function get_config(){
         ...
         */
        $apiConfig = require(linksynceparcel_DIR.'/includes/api/ls-api-info.php');
    ...
    {
        return get_option('linksynceparcel_laid', $default);
    }
    ...
    {
        return update_option('linksynceparcel_laid', trim($laid));
    }
